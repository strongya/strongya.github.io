...
import { o as objectType, h as dateType, i as arrayType, j as stringType, A as AstroError, U as UnknownContentCollectionError, a as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, k as escape, l as renderUniqueStylesheet, n as renderScriptElement, p as createHeadAndContent, r as renderComponent } from './astro/server_BiBTG5Z9.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Bvc_6Obo.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://strongya.github.io", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CQOZvrPj.mjs').then(n => n._);
